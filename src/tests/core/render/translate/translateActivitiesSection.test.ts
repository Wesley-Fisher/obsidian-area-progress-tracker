...
describe("render/translate/translateActivitiesSection", () => {
  ...
  it("translates button/checkbox/number actions and record inputs into entry models", () => {
    const config: SystemConfig = {
      ...
      actions: [
        { id: "walk", name: "Walk", input: { type: "button", step: 2 }, effects: {}, max: 2, groupId: "g1" },
        { id: "meditate", name: "Meditate", input: { type: "checkbox" }, effects: {}, max: 0 },
        { id: "pushups", name: "Pushups", input: { type: "number", max: 10, step: 1 }, effects: {}, max: 5 },
      ],
      records: [{ id: "mood", name: "Mood", input: { type: "text" }, groupId: "g1" }],
    };
